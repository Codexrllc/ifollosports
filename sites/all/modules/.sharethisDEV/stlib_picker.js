...
(function () {
  ...
  stlib_picker.setupPicker = function (jQElement, newDefaults, callback) {
    ...
    for (i = 0; i < pickerDefaults.length; i++) {
      ...
      // }
      if (isSecure) {
        ul.append('<li id="st_li_"' + pickerDefaults[i] + ' class="stp_li"><img src="https://ws.sharethis.com/images/"' + pickerDefaults[i] + '_32.png></img><span class="stp_liText">' + pickerDefaults[i] + '</span></li>');
      }
      else {
